...
export const metadata: Metadata = {
  title: "Pricing — Abitur Premium",
  description: "Unlock unlimited Abitur practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=abitur&cadence=annual`;
