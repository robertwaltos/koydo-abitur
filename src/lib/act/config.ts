// Auto-generated shim — re-exports from @/lib/abitur/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _abitur_Config } from "@/lib/abitur/config";
import { EXAM_CONFIG as _raw } from "@/lib/abitur/config";
